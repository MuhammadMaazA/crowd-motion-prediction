#!/bin/bash
# Train base Social-LSTM on all 5 ETH/UCY holdout scenes.
# Launch: nohup bash train_slstm_sequential.sh > logs/slstm_train.log 2>&1 &
...
for scene in "${SCENES[@]}"; do
    echo "========================================"
    echo "  Training Social-LSTM: $scene"
    echo "  Started: $(date)"
    echo "========================================"
